...
Iteração 3 (número 2): O valor vira 3. Atende ao else if (ímpar), somando -3. (soma = 8 - 3 = 5)

Iteração 4 (número 9): O valor vira 10. Atende ao primeiro if (par e > 5). (soma = 5 + 10 = 15)
